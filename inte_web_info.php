...
<?php 
    ...
    $sql = "SELECT * FROM fiche_metier WHERE id = '9'";
...
echo"
    <div class=fiche>
        <header>
        <!--Je vais chercher dans la base de données le nom du métier qui correspond à l'id numéro 9-->
            <h1>".$data['nom_metier']."</h1>
            <!--Je vais chercher dans la base de données la description du métier qui correspond à l'id numéro 9-->
            <p>
            ".$data['description']."                               
            </p>
        </header>
        ...
        <main>
            ...
            <!--Je vais chercher dans la base de données les études du métier qui correspond à l'id numéro 9-->
            <p>
            ".$data['etudes']."                              
            </p>
            ...
            <div class='bloc_citation'>
                ...
                echo substr($temoignage, 809, 559); 
                echo"                        
                </p>
            ...
            <h4 class='poste'>";
            $temoignage = $data['temoignage'];
            echo substr($temoignage, 11, 53); 
            echo"</h4>
            <img src='img/avatar_fiche-yanis.png' class='personnage'>
            </div>
            ...
            <div class='bloc_competences'>
                ...
                <img src='img/diagramme-integrateur.png' class='diagramme'>
            ...
            <div class='bloc_citation'>
                ...
                ";
                $temoignage = $data['temoignage'];
                echo substr($temoignage, 1368, 594); 
                echo"                 
                </p>
        ...
        <adress class='plus_infos'>
            ...
            <a href='http://www.onisep.fr/Ressources/Univers-Metier/Metiers/integrateur-integratrice-web'>
                http://www.onisep.fr/Ressources/Univers-Metier/Metiers/integrateur-integratrice-web
            </a></br>

            <a href='https://www.alticreation.com/integrateur-web/'>
                https://www.alticreation.com/integrateur-web/
            </a></br>

            <a href='http://etudiant.aujourdhui.fr/etudiant/metiers/fiche-metier/integrateur-web.html'>
                http://etudiant.aujourdhui.fr/etudiant/metiers/fiche-metier/integrateur-web.html
            </a>
        ...
        <footer>
            ...
            <a href='admin_reseaux_info.php' class='metier_precedent'>
            <img src='img/fleche_gauche.png' class='fleche_metier_precedent'>
            Métier précedent
            </a>             

            <a href='anim2D3D_info.php' class='metier_suivant'>
            Métier suivant
