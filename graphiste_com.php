...
<?php 
    ...
    $sql = "SELECT * FROM fiche_metier WHERE id = '6'";
...
<body>
    <div class=fiche>
        <header>
        <!--Je vais chercher dans la base de données le nom du métier qui correspond à l'id numéro 6-->
            <h1>".$data['nom_metier']."</h1>
            <!--Je vais chercher dans la base de données la description du métier qui correspond à l'id numéro 6-->
            <p>
            ".$data['description']."                               
            </p>
        </header>
        ...
        <!--Ici je sépare mon main en deux colonnes, je travaille d'abord sur la colonne 1 puis viendra la 2-->
            ...
            <!--Je vais chercher dans la base de données les études du métier qui correspond à l'id numéro 6-->
            <p>
            ".$data['etudes']."                              
            </p>
            ...
            <div class='bloc_citation'>
                ...
                echo substr($temoignage, 471, 560); 
                echo"                                            
                </p>
            ...
            <h4 class='poste'>";
            $temoignage = $data['temoignage'];
            echo substr($temoignage, 13, 20); 
            echo"</h4>
            <img src='img/avatar_fiche-natacha.png' class='personnage'>
            </div>
            ...
            <div class='bloc_competences'>
                ...
                <img src='img/diagramme-graphiste.png' class='diagramme'>
            ...
            <div class='bloc_citation'>
                ...
                ";
                $temoignage = $data['temoignage'];
                echo substr($temoignage, 1031, 838); 
                echo"                               
                </p>
        ...
        <adress class='plus_infos'>
            ...
            <a href='http://etudiant.aujourdhui.fr/etudiant/metiers/fiche-metier/graphiste.html'>
                http://etudiant.aujourdhui.fr/etudiant/metiers/fiche-metier/graphiste.html
            </a></br>

            <a href='http://www.onisep.fr/Ressources/Univers-Metier/Metiers/designer-graphique'>
                http://www.onisep.fr/Ressources/Univers-Metier/Metiers/designer-graphique
            </a></br>

            <a href='https://www.cidj.com/metiers/graphiste-multimedia'>
                https://www.cidj.com/metiers/graphiste-multimedia
            </a>
        ...
        <footer>
            ...
            <a href='chef_projet_com.php' class='metier_precedent'>
