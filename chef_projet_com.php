...
<?php 
    ...
    $sql = "SELECT * FROM fiche_metier WHERE id = '5'";
...
<body>
    <div class=fiche>
        <header>
        <!--Je vais chercher dans la base de données le nom du métier qui correspond à l'id numéro 5-->
            <h1>".$data['nom_metier']."</h1>
            <!--Je vais chercher dans la base de données la description du métier qui correspond à l'id numéro 5-->
            <p>
            ".$data['description']."                               
            </p>
        </header>
        ...
        <!--Ici je sépare mon main en deux colonnes, je travaille d'abord sur la colonne 1 puis viendra la 2-->
            ...
            <!--Je vais chercher dans la base de données les études du métier qui correspond à l'id numéro 5-->
            <p>
            ".$data['etudes']."                              
            </p>
            ...
            <div class='bloc_citation'>
                ...
                echo substr($temoignage, 472, 442); 
                echo"                       
                </p>
            ...
            <h3 class='prenom'>";
            $temoignage = $data['temoignage'];
            echo substr($temoignage, 0, 4); 
            echo"</h3>
            <h4 class='poste'>";
            $temoignage = $data['temoignage'];
            echo substr($temoignage, 8, 55); 
            echo"</h4>
            <img src='img/avatar_fiche-eric.png' class='personnage'>
            </div>
            ...
            <div class='bloc_competences'>
                ...
                <img src='img/diagramme-chef_projet.png' class='diagramme'>
            ...
            <div class='bloc_citation'>
                ...
                ";
                $temoignage = $data['temoignage'];
                echo substr($temoignage, 914, 594); 
                echo"                                  
                </p>
        ...
        <adress class='plus_infos'>
            ...
            <a href='https://ecole-du-digital.com/metier/chef-de-projet-digital-fiche-metier/'>
                https://ecole-du-digital.com/metier/chef-de-projet-digital-fiche-metier/
            </a></br>

            <a href='https://diplomeo.com/formations-metier-pour-devenir-chef_de_projet'>
                https://diplomeo.com/formations-metier-pour-devenir-chef_de_projet
            </a></br>
        ...
        <footer>
            ...
            <a href='ux_design_com.php' class='metier_precedent'>
            <img src='img/fleche_gauche.png' class='fleche_metier_precedent'>
            Métier précedent
            </a>

            <a href='graphiste_com.php' class='metier_suivant'>
            Métier suivant
