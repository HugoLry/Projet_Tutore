...
<?php 
    ...
    $sql = "SELECT * FROM fiche_metier WHERE id = '3'";
...
echo"
    <div class=fiche>
        <header>
        <!--Je vais chercher dans la base de données le nom du métier qui correspond à l'id numéro 3-->
            <h1>".$data['nom_metier']."</h1>
            <!--Je vais chercher dans la base de données la description du métier qui correspond à l'id numéro 3-->
            <p>
            ".$data['description']."                               
            </p>
        </header>
        ...
        <!--Ici je sépare mon main en deux colonnes, je travaille d'abord sur la colonne 1 puis viendra la 2-->
            ...
            <!--Je vais chercher dans la base de données les études du métier qui correspond à l'id numéro 3-->
            <p>
            ".$data['etudes']."                              
            </p>
            ...
            <div class='bloc_citation'>
                ...
                echo substr($temoignage, 526, 602); 
                echo"                           
                </p>
            ...
            <h3 class='prenom'>";
            $temoignage = $data['temoignage'];
            echo substr($temoignage, 0, 15); 
            echo"</h3>
            <h4 class='poste'>";
            $temoignage = $data['temoignage'];
            echo substr($temoignage, 20, 75); 
            echo"</h4>
            <img src='img/avatar_fiche-solenne.png' class='personnage'>
            </div>
            ...
            <div class='bloc_competences'>
                ...
                <img src='img/diagramme-charge_com.png' class='diagramme'>
            ...
            <div class='bloc_citation'>
                ...
                ";
                $temoignage = $data['temoignage'];
                echo substr($temoignage, 1128, 464); 
                echo"                
                </p>
        ...
        <adress class='plus_infos'>
            ...
            <a href='https://www.orientation.com/metiers/charge-de-communication.html'>
                https://www.orientation.com/metiers/charge-de-communication.html
            </a></br>

            <a href='http://www.onisep.fr/Ressources/Univers-Metier/Metiers/charge-chargee-de-communication-interne'>
                http://www.onisep.fr/Ressources/Univers-Metier/Metiers/charge-chargee-de-communication-interne
            </a></br>

            <a href='https://www.top-metiers.fr/communication'>
                https://www.top-metiers.fr/communication
            </a>
        ...
        <footer>
            ...
            <a href='real_multimedia_com.php' class='metier_precedent'>
            <img src='img/fleche_gauche.png' class='fleche_metier_precedent'>
            Métier précedent
            </a>

            <a href='ux_design_com.php' class='metier_suivant'>
            Métier suivant
