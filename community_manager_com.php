...
<?php 
    ...
    $sql = "SELECT * FROM fiche_metier WHERE id = '1'";
...
<body>
    <div class=fiche>
        <header>
        <!--Je vais chercher dans la base de données le nom du métier qui correspond à l'id numéro 1-->
            <h1>".$data['nom_metier']."</h1>
            <!--Je vais chercher dans la base de données la description du métier qui correspond à l'id numéro 1-->
            <p>
            ".$data['description']."                               
            </p>
        </header>
        ...
        <!--Ici je sépare mon main en deux colonnes, je travaille d'abord sur la colonne 1 puis viendra la 2-->
            ...
            <!--Je vais chercher dans la base de données les études du métier qui correspond à l'id numéro 1-->
            <p>
            ".$data['etudes']."                              
            </p>
            ...
            <div class='bloc_citation'>
                ...
                echo substr($temoignage, 582, 670); 
                echo"                           
                </p>
            ...
            <h3 class='prenom'>";
            $temoignage = $data['temoignage'];
            echo substr($temoignage, 0, 17); 
            echo"</h3>
            <h4 class='poste'>";
            $temoignage = $data['temoignage'];
            echo substr($temoignage, 21, 100); 
            echo"</h4>
            <img src='img/avatar_fiche-helene.png' class='personnage'>
            </div>
            ...
            <div class='bloc_citation'>
                ...
                ";
                $temoignage = $data['temoignage'];
                echo substr($temoignage, 121, 461); 
                echo"                                  
                </p>
            ...
            <div class='bloc_competences'>
                ...
                <img src='img/diagramme-community_manager.png' class='diagramme'>
            ...
            <div class='bloc_citation'>
                ...
                ";
                $temoignage = $data['temoignage'];
                echo substr($temoignage, 1252, 405); 
                echo"                    
                </p>
        ...
        <adress class='plus_infos'>
            ...
            <a href='http://www.onisep.fr/Ressources/Univers-Metier/Metiers/community-manager'>
                http://www.onisep.fr/Ressources/Univers-Metier/Metiers/community-manager
            </a></br>

            <a href='https://www.regionsjob.com/observatoire-metiers/fiche/community-manager'>
                https://www.regionsjob.com/observatoire-metiers/fiche/community-manager
            </a></br>

            <a href='https://www.orientation-pour-tous.fr/metier/community-manager,15152.html'>
                https://www.orientation-pour-tous.fr/metier/community-manager,15152.html
            </a>
        ...
        <footer>
            ...
            <a href='real_multimedia_com.php' class='metier_suivant_com_manager'>
            Métier suivant
