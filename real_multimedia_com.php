...
<?php 
    ...
    $sql = "SELECT * FROM fiche_metier WHERE id = '2'";
...
<body>
    <div class=fiche>
        <header>
        <!--Je vais chercher dans la base de données le nom du métier qui correspond à l'id numéro 2-->
            <h1>".$data['nom_metier']."</h1>
            <!--Je vais chercher dans la base de données la description du métier qui correspond à l'id numéro 2-->
            <p>
            ".$data['description']."                               
            </p>
        </header>
        ...
        <!--Ici je sépare mon main en deux colonnes, je travaille d'abord sur la colonne 1 puis viendra la 2-->
            ...
            <!--Je vais chercher dans la base de données les études du métier qui correspond à l'id numéro 2-->
            <p>
            ".$data['etudes']."                              
            </p>
            ...
            <div class='bloc_citation'>
                ...
                echo substr($temoignage, 681, 803); 
                echo"                             
                </p>
            ...
            <h4 class='poste'>";
            $temoignage = $data['temoignage'];
            echo substr($temoignage, 24, 36); 
            echo"</h4>
            <img src='img/avatar_fiche-johann.png' class='personnage'>
            </div>
            ...
            <div class='bloc_competences'>
                ...
                <img src='img/diagramme-realisateur.png' class='diagramme'>
            ...
            <div class='bloc_citation'>
                ...
                ";
                $temoignage = $data['temoignage'];
                echo substr($temoignage, 1484, 365); 
                echo"         
                </p>
        ...
        <adress class='plus_infos'>
            ...
            <a href='https://www.orientation.com/metiers/realisateur-multimedia.html'>
                https://www.orientation.com/metiers/realisateur-multimedia.html
            </a></br>

            <a href='https://www.oriane.info/metier/node/497'>
                https://www.oriane.info/metier/node/497
            </a></br>

            <a href='https://www.studyrama.com/formations/fiches-metiers/audiovisuel-cinema/realisateur-au-cinema-790#formations'>
                https://www.studyrama.com/formations/fiches-metiers/audiovisuel-cinema/realisateur-au-cinema-790#formations
            </a>
        ...
        <footer>
            ...
            <a href='community_manager_com.php' class='metier_precedent'>
            <img src='img/fleche_gauche.png' class='fleche_metier_precedent'>
            Métier précedent
            </a>
            
            <a href='charge_com_com.php' class='metier_suivant'>
            Métier suivant
