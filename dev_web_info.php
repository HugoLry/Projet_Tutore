...
<?php 
    ...
    $sql = "SELECT * FROM fiche_metier WHERE id = '7'";
...
echo"
    <div class=fiche>
        <header>
            <!--Je vais chercher dans la base de données le nom du métier qui correspond à l'id numéro 7-->
            <h1>".$data['nom_metier']."</h1>

            <!--Je vais chercher dans la base de données la description du métier qui correspond à l'id numéro 7-->
            <p>
            ".$data['description']."                               
            </p>
        </header>
        ...
        <!--Ici je sépare mon main en deux colonnes, je travaille d'abord sur la colonne 1 puis viendra la 2-->
            ...
            <!--Je vais chercher dans la base de données les études du métier qui correspond à l'id numéro 7-->
            <p>
            ".$data['etudes']."                              
            </p>
            ...
            <div class='bloc_citation'>
                ...
                echo substr($temoignage,  484, 639); 
                echo"</p>
            ...
            <!--Je vais chercher dans la base de données les évolutions du métier qui correspond à l'id numéro 7-->
            <p>
            ".$data['evolution']."                             
            </p>
            ...
            <!--J'arrive enfin à ma colonne 2 que je délimite grâce à une section-->
            ...
            <h3 class='prenom'>";
            $temoignage = $data['temoignage'];
            echo substr($temoignage, 0, 18); 
            echo"</h3>
            <h4 class='poste'>";
            $temoignage = $data['temoignage'];
            echo substr($temoignage, 25, 46); 
            echo"</h4>
            <img src='img/avatar_fiche-alexandre.png' class='personnage'>
            </div>
            ...
            <div class='bloc_competences'>
                ...
                <img src='img/diagramme-dev_web.png' class='diagramme'>
                ...
                <!--Je vais chercher dans la base de données les compétences de ce métier qui correspond à l'id numéro 7-->
            ...
            <div class='bloc_citation'>
                ...
                <p class='citation3_dev_web'>";
                $temoignage = $data['temoignage'];
                echo substr($temoignage, 1123, 404); 
                echo"                    
                </p>
            ...
            <!--Je vais chercher dans la base de données le salaire du métier qui correspond à l'id numéro 7-->
        ...
        <a href='https://www.cidj.com/metiers/developpeur-developpeuse-web'>
            https://www.cidj.com/metiers/developpeur-developpeuse-web
        </a></br>

        <a href='https://www.inteam.fr/fiche-metier/developpeur-web/'>
            https://www.inteam.fr/fiche-metier/developpeur-web/
        </a></br>

        <a href='http://etudiant.aujourdhui.fr/etudiant/metiers/fiche-metier/developpeur-web.html'>
            http://etudiant.aujourdhui.fr/etudiant/metiers/fiche-metier/developpeur-web.html
        </a>
        ...
        <footer>
            <a href='admin_reseaux_info.php' class='metier_suivant_dev_web'>
            Métier suivant
